...
const modals = () => {
  ...
  function openByScroll(selector) {
    //if user scroll page to footer and didn`t click any button
    window.addEventListener('scroll', () => {
      let scrollHeight = Math.max(document.documentElement.scrollHeight, document.documentElement.clientHeight);
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])("#size", "#material", "#options", ".promocode", ".calc-price", state);
